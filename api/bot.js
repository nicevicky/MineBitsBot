...
<i>Join thousands earning crypto daily! 🚀</i>
      ...
      await axios.post(`${API_URL}/sendAnimation`, {
        chat_id: chatId,
            ...
            reply_markup: {
              inline_keyboard: [
                [
                  {
                    text: "📤 Share Link",
                    url: `https://t.me/share/url?url=${encodeURIComponent(inviteLink)}&text=${encodeURIComponent("🚀 Join me on Crypto Miner Bot and start earning crypto daily! Free registration bonus awaiting! ⛏️💰")}`
                  }
                ],
                [
                  {
